...
cd /www/wwwroot/fusionpbx && php /www/wwwroot/fusionpbx/core/upgrade/upgrade_schema.php > /dev/null 2>&1
...
chown -R freeswitch.daemon /etc/freeswitch /var/lib/freeswitch /var/log/freeswitch /usr/share/freeswitch /www/wwwroot/fusionpbx
